...
|---|---|---|---|---|
| CLAUDE_CODE_OAUTH_TOKEN | 登録済み✅ | 2026-07-08(建国日) | **2027-07-08**(あと335日) | `claude setup-token` で発行。失効=全社停止 |
...
**最終更新: 2026-08-07(マモル 週次)**
**最短失効: CLAUDE_CODE_OAUTH_TOKEN — 2027-07-08(あと335日)。2027-06-08までに再発行依頼掲示が必要。**
